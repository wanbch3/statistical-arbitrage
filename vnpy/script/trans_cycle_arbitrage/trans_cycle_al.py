...
if __name__ == '__main__':
    ...
    dominant_future_list, date_seperate = get_dominant_future_list('AL', start_date, end_date)
    second_dominant_future_list = get_second_dominant_future_list('AL', dominant_future_list, date_seperate)

    dominant_future_list = list(map(lambda x:jq_to_vnpy(x.replace('AL', 'al')),dominant_future_list))
    second_dominant_future_list = list(map(lambda x: jq_to_vnpy(x.replace('AL', 'al')), second_dominant_future_list))
